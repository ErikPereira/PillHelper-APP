...
public class Constants {
    ...
    public static final String BASE_URL = "http://192.168.1.12:3000/"; //URL BASE
    ...
    public static final String REMOVE_BULLA = "removeBulla";
    ...
    public static final String WHO_USER_FRAG = "who_user_frag";
